...
Executed ahead of Phase 3 (Chat Panel + Streaming, still open) — all three sub-parts here are independent of the chat/streaming UI work, so there was no reason to block on it.
